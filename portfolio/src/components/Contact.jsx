...
<h2 className="headline-1 mb-8 lg:max-w-[12ch] reveal-up">
          ...
          <p className="text-zinc-400 mt-3 mb-8 max-w-[50ch] lg:max-w-[60ch] reveal-up">
        ...
        <form action="https://getform.io/f/azygxknb" method="POST" className="xl:pl-10 2xl:pl-20">
          ...
          <button type="submit" className="btn btn-primary w-full !max-w-full justify-center reveal-up">
            Submit
          </button>
        </form>
      </div>
